...
CHECKPOINT="checkpoint-399"  # checkpoint name for saved models
...
EXP_NAMES=("Qwen2_5-VL-7B-Instruct_GRPO_flowers_base_e_2_e") #folder name where model checkpoints are saved. baseline for base model evaluation
