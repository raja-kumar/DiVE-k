...
MODEL_ROOT="/app/saved_models_cluster/vrft/oxford_flowers/"  # root path for saved models
BASE_MODEL="Qwen/Qwen2.5-VL-7B-Instruct"
# BASE_MODEL="google/gemma-3-12b-it"
CHECKPOINT="final_weights"  # checkpoint name for saved models
...
EXP_NAMES=("Qwen2_5-VL-7B-Instruct_GRPO_flowers_base_e_2_e_hard_negative") #folder name where model checkpoints are saved. baseline for base model evaluation
