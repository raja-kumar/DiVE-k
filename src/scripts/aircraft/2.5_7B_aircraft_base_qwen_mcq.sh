...
export SAVE_PATH=/app/saved_models/vrft/fgvc_aircraft/Qwen2_5-VL-7B-Instruct_GRPO_aircraft_base_qwen_mcq
export RUN_NAME=Qwen2_5-VL-7B-Instruct_GRPO_aircraft_base_qwen_mcq
