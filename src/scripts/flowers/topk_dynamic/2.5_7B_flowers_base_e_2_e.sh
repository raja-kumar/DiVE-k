...
export LOG_PATH="./logs/debug_log_Qwen2_5-VL-7B-flower_base_e_2_e.txt"
...
export SAVE_PATH=/app/saved_models/vrft/ckpts/Qwen2_5-VL-7B-Instruct_GRPO_flowers_base_e_2_e
export RUN_NAME=Qwen2_5-VL-7B-Instruct_GRPO_flowers_base_e_2_e
