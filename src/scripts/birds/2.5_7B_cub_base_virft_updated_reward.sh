...
export SAVE_PATH=/app/saved_models/vrft/CUB_200_2011/Qwen2_5-VL-7B-Instruct_GRPO_cub_base_virft_updated_reward
export RUN_NAME=Qwen2_5-VL-7B_GRPO_cub_base_virft_updated_reward
