...
export LOG_PATH="./logs/debug_log_gemma-3-4B-cub_base_qwen_mcq.txt"
...
export CKPT_PATH="google/gemma-3-4b-it"
export SAVE_PATH=/app/saved_models/vrft/CUB_200_2011/gemma-3-4B_GRPO_cub_base_qwen_mcq
export RUN_NAME=gemma-3-4B_GRPO_cub_base_qwen_mcq
